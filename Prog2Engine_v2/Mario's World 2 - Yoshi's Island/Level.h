...
{
public:
	Level(const std::string& imagePathLvlTxt, const std::string& backgroundTxt1, const std::string& backgroundTxt2,const std::string& backgroundTxt3,float levelStart,Point2f levelEnd, int levelNumber, StateManager* stateManager);
	~Level();
